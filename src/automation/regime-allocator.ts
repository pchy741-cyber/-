...
const DEFAULT_WEIGHTS: Record<RegimeType, Partial<Record<StrategyMode, number>>> = {
  // v13-fix: BREAKOUT 가중치 대폭 축소 (14일 전 시간대 합산 -167만 손실, 승률 42%)
  // SNIPER 가중치 강화 (승률 75%, 평균 +1.59% — 최고 전략)
  BULLISH:  { SWING: 40, SNIPER: 35, BREAKOUT: 10, BOTTOM_FISHING: 10, DEFENSE: 5 },
  NEUTRAL:  { SWING: 40, SNIPER: 25, DEFENSE: 15, BOTTOM_FISHING: 15, BREAKOUT: 5 },
  BEARISH:  { DEFENSE: 35, BOTTOM_FISHING: 25, SWING: 25, SNIPER: 10, BREAKOUT: 5 },
  CRASH:    { DEFENSE: 45, BOTTOM_FISHING: 25, SWING: 20, SNIPER: 10, BREAKOUT: 0 },
};
