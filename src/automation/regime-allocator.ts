...
// 전략 다양성 확보 — 데이터 스누핑 방지를 위해 모든 전략에 최소 가중치 부여
const DEFAULT_WEIGHTS: Record<RegimeType, Partial<Record<StrategyMode, number>>> = {
  BULLISH:  { SWING: 30, SNIPER: 25, BREAKOUT: 20, SCALPING: 15, BOTTOM_FISHING: 5, DEFENSE: 5 },
  NEUTRAL:  { SWING: 35, DEFENSE: 20, SNIPER: 15, BOTTOM_FISHING: 10, SCALPING: 10, BREAKOUT: 10 },
  BEARISH:  { DEFENSE: 35, BOTTOM_FISHING: 25, SWING: 20, SCALPING: 10, BREAKOUT: 5, SNIPER: 5 },
  CRASH:    { DEFENSE: 45, BOTTOM_FISHING: 25, SWING: 15, SCALPING: 5, BREAKOUT: 5, SNIPER: 5 },
};
