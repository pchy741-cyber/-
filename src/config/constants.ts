...
export const STRATEGY_PARAMS = {
  SWING: {
    ...
    // │ buyThreshold 75: 68~74 저확신 구간 제거 → 진입 품질 우선          │
  ...
  SCALPING: {
    ...
    // │ 익절 +2.0% → 순수익 +1.75% / 손절 -1.0% → 순손실 -1.25%          │
    // │ 손익비 2:1 / 손익분기 승률 42% — 수수료(0.25%) 감안 실손익분기     │
    // │ 진입 강화: 모멘텀 신호 2개+ + 거래량 3x+ → 목표 승률 50%+         │
    // └────────────────────────────────────────────────────────────────────┘
    buyThreshold: 75,
    // 75점: AI+기술지표 모두 강세여야 진입 (72→75, 품질 우선)
    ...
    forceCloseTime: '09:30',// 09:30까지 연장 — TP 2% 달성 시간 확보 (기존 09:25)
  },
