...
gcloud run deploy $SERVICE \
    ...
    --set-env-vars="NODE_ENV=production,TRADING_MODE=live,INSTANCE_UNIX_SOCKET=/cloudsql/quantops-trading:asia-northeast3:quantops-db,DB_DATABASE=quantops,DB_USER=postgres,RISK_MAX_DAILY_DRAWDOWN_KRW=500000,RISK_MAX_POSITION_KRW=3000000,RISK_MAX_TOTAL_INVESTED_PCT=90" \
    --set-secrets="\
...
echo ""
echo "  🟢 현재 모드: LIVE (실전투자)"
echo "     모의투자 전환: TRADING_MODE=paper 로 변경 후 재배포"
echo ""
